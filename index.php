...
Katya Zakharova:
1. Подсчет отработанного времени за месяц: по часам и по дням, при этом в старом туду по дням (т.е. часы делить на 8) - не всегда правильно округлялись.
2. Когда открываешь список сотрудников с рабочими часами, список должен быть свернут или должна быть кнопка - свернуть список, чтобы не в каждого тыкать )
3. Чтобы можно было посмотреть рабочее время каждого сотрудника по каждому проекту (это вроде бы было в старом)
4. Проставленные часы в новом туду очень бледные
-->
</pre>
	</div>
